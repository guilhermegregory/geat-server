exports.seed = (knex) => {
  return knex('moves').del()
    ...
    .then(() => knex('users').insert([
      { id: 10000, name: 'User #1', email: 'user1@email.com', password: '$2a$10$ngFCjFgKsgwYo3zgpfScJexUBc6lF7AbnNdWz4WwnAKJ5AvVUy61y' },
      { id: 10001, name: 'User #2', email: 'user2@email.com', password: '$2a$10$ngFCjFgKsgwYo3zgpfScJexUBc6lF7AbnNdWz4WwnAKJ5AvVUy61y' },
    ]));
};
